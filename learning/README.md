...
| llm | [Pretraining](llm/pretraining/) | Train a model from scratch at scale: data, tokenizer, distributed training, and a defensible compute budget | 14 |
| llm | [Post-training](llm/post-training/) | Align a base model: SFT, reward modeling, RLHF, DPO, and GRPO, and knowing which one to pick | 0 |
...
| llm | [Agents](llm/agents/) | Build the loop yourself: tools, context, memory, and knowing when an agent is the wrong answer | 37 |
