...
- Queries, query plans, schema design and isolation semantics: see [`programming/sql`](../../programming/sql/), linked to rather than restated. This workspace owns the running instance, not the language.
