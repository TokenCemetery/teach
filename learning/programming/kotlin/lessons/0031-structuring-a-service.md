...
![For com.acme.billing.invoice.pdf.Renderer, a pure Kotlin project puts the file at invoice/pdf/Renderer.kt, omitting the com/acme/billing root. A mixed Kotlin and Java project instead mirrors the full path, com/acme/billing/invoice/pdf/Renderer.kt.](images/source-tree-conventions.svg)
