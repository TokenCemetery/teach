...
Stages 1 to 4 are written: lessons 0001 to 0027, plus six reference sheets. Stages 5 to 7 are unwritten.
...
**How the glossary is populated here.** The skill says a term lands once it can be used correctly, which is a statement about a learner's demonstration. These lessons have no single learner, so the test is applied to the material instead: a term lands when a lesson has taught it well enough for a reader to use it. Stage 1 added six terms alongside the three pinned ones, stage 2 added seven, stage 3 added eight, and stage 4 added seven. Keep doing this per stage rather than upfront, and do not add a term the lessons have not earned.
